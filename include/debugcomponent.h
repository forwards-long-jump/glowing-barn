...
{
public:
    DebugComponent(const QColor& color = QColor(0, 255, 255, 127), bool hasHitboxComponent = false, bool hasTextComponent = true, const QString& debugText = "", const QString& name = "DebugComponent");
